...
sakai.editor.editors.ckeditor.launch = function(targetId, config, w, h) {
    ...
    var ckconfig = {
        ...
        [
            ...
            (sakai.editor.enableResourceSearch
                ? ['warpwire','ResourceSearch', 'Image','Movie','Flash','Table','HorizontalRule','Smiley','SpecialChar','fmath_formula']
                : ['warpwire','Image','Movie','Flash','Table','HorizontalRule','Smiley','SpecialChar','fmath_formula']),
            '/',
    ...
    if (config) {
		...
		(function() { 
		   ...
		   CKEDITOR.plugins.addExternal('warpwire',basePath+'warpwire/', 'plugin.js');
			 /*
			 ...
			 */
			 ...
			 ckconfig.extraPlugins+="warpwire,movieplayer,wordcount,fmath_formula";
    })();
